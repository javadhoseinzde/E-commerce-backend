...
class RegisterAPIView(APIView):
    ...
    def post(self, request):
        ...
        if not mobile:
            return Response(
                result_message("ERROR", 400, "mobile is required"),
        ...
        try:
            ...
            return Response(
                result_message("ERROR", 404, "User not found"),
...
class VerifyAPIView(APIView):
    ...
    def post(self, request):
        ...
        # مقایسه OTP وارد شده با OTP ذخیره شده
        if str(user.otp) != str(otp):
            return Response(
                result_message("ERROR", 400, "Wrong OTP"),
                status=status.HTTP_400_BAD_REQUEST
            )
